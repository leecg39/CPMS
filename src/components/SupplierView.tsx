    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-xs text-indigo-600 hover:text-indigo-800 font-bold bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-xl transition-colors cursor-pointer flex items-center gap-1"
          >
                ...
                {ordersNeedingQuotation.map((order) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer shrink-0 flex items-center gap-1"
                    >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="px-2.5 py-1.5 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-xl text-xs font-bold transition-all shadow-2xs cursor-pointer flex items-center gap-1"
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer flex items-center gap-1"
                      >
                        <Truck className="w-3.5 h-3.5" />
                        <span>출하 등록</span>
                      </button>
      ...
      {activeSubTab === 'quotations' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">제출된 자재 단가 견적서(Quotation) 목록</h3>
              <p className="text-xs text-slate-500">현장 발주 건에 대해 제안한 단가, 납기 소요 일수 및 승인 채택 상태</p>
            </div>
            <button
              onClick={() => onOpenManual('man-06')}
      ...
      {activeSubTab === 'deliveries' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">자재 출하 및 실시간 배송(Delivery) 현황</h3>
              <p className="text-xs text-slate-500">운송 화물차량 번호, 기사 연락처, 예상 도착 시간 및 현장 검수 진행 상태</p>
            </div>
            <button
              onClick={() => onOpenManual('man-07')}
      ...
      {activeSubTab === 'invoices' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">전자세금계산서/송장(Invoice) 발행 및 청구 내역</h3>
              <p className="text-xs text-slate-500">검수 완료 자재에 대한 공급가액/부가세 계산서 발행 및 현장 청구</p>
            </div>
            <button
                ...
                {deliveredOrdersNeedingInvoice.map((o) => (
                  <div key={o.id} className="p-3 bg-white rounded-xl border border-purple-200 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-purple-600 hover:bg-purple-500 text-white rounded-xl text-xs font-bold shadow-xs cursor-pointer flex items-center gap-1 shrink-0"
                    >
                      <Receipt className="w-3.5 h-3.5" />
                      <span>송장 발행</span>
                    </button>
      ...
      {activeSubTab === 'payments' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">수금 및 자재 대금 결제 확인 대장</h3>
              <p className="text-xs text-slate-500">현장에서 지급 완료된 법인 계좌이체 및 정산 마감 내역</p>
            </div>
            <button
